...
if (
    ...
    $stmt1 = $mysqli->prepare("INSERT INTO booking_t1 (date, timeslot, title, name, email, tel, meeting, manutitle, booking_id)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    if ($result1 && $result2) {
        ...
        $sToken = ["LN8KPFOSBCYWrDpZThezFPSo76uK0atqX8slQFbLJ2z"]; // เปลี่ยนเป็น Line Notify Token ของคุณ
        $sMessage = "Booking\r\n";
        $sMessage .= "\n";
